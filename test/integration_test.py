...
class ThornodeBot(unittest.TestCase):
    ...
    def test_start(self):
        self.telegram.send_message(BOT_ID, "/start")
        time.sleep(3)

        response = next(self.telegram.iter_history(BOT_ID))
    ...
    def test_my_thornodes(self):
        ...
        self.telegram.send_message(BOT_ID, "📡 MY NODES")
        time.sleep(3)
    ...
    def test_delete_address(self, confirm):
        valid_address = self.add_valid_address()
        self.telegram.send_message(BOT_ID, "/start")
        time.sleep(3)
        self.telegram.send_message(BOT_ID, "📡 MY NODES")
        ...
        first_response = next(self.telegram.iter_history(BOT_ID))
        ...
        if confirm:
            ...
            time.sleep(3)
            second_response_1 = next(itertools.islice(self.telegram.iter_history(BOT_ID), 1, None))
            second_response_2 = next(itertools.islice(self.telegram.iter_history(BOT_ID), 0, None))
            ...
            time.sleep(3)
            second_response = next(self.telegram.iter_history(BOT_ID))
    ...
    def test_change_alias(self, alias, expected_response1, expected_response2):
        self.add_valid_address()
        ...
        first_response = next(self.telegram.iter_history(BOT_ID))
        self.telegram.send_message(BOT_ID, alias)
        time.sleep(3)
        second_response_1 = next(itertools.islice(self.telegram.iter_history(BOT_ID), 1, None))
        second_response_2 = next(itertools.islice(self.telegram.iter_history(BOT_ID), 0, None))
    ...
    def test_add_all_addresses(self, confirm):
        self.telegram.send_message(BOT_ID, "/start")
        time.sleep(3)
        self.telegram.send_message(BOT_ID, "📡 MY NODES")
        time.sleep(3)
    ...
    def test_delete_all_addresses(self, confirm):
        self.telegram.send_message(BOT_ID, "/start")
        time.sleep(3)
        self.telegram.send_message(BOT_ID, "📡 MY NODES")
        time.sleep(3)
    ...
    def test_network(self):
        ...
        self.telegram.send_message(BOT_ID, "🌎 NETWORK")
    ...
    def test_show_all_thorchain_nodes(self):
        ...
        self.telegram.send_message(BOT_ID, "👀 SHOW ALL")
    ...
    def test_admin_area(self):
        ...
        self.telegram.send_message(BOT_ID, "🔑 ADMIN AREA")
        time.sleep(3)
    ...
    def assert_add_address(self, address, expected_response1, expected_response2):
        ...
        first_response = next(self.telegram.iter_history(BOT_ID))
        self.telegram.send_message(BOT_ID, address)
        time.sleep(3)
        second_response_1 = next(itertools.islice(self.telegram.iter_history(BOT_ID), 1, None))
        second_response_2 = next(itertools.islice(self.telegram.iter_history(BOT_ID), 0, None))
    ...
    def assert_restart_container(self, confirm):
        ...
        self.telegram.send_message(BOT_ID, "🔑 ADMIN AREA")
        time.sleep(3)
        setup_response = next(self.telegram.iter_history(BOT_ID))
